...
- supports fight, defend, heal-player, status, and light modes through the companion MakeCode extension
- built for Minecraft Education 1.21.133

Implementation note:

- Version 2.7.0 is script-backed. Ownership, one-hero enforcement, live labels, cross-dimension return behavior, MakeCode-triggered modes, and light mode currently rely on the behavior-pack script.
